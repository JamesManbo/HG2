...
{
    public class TuyenSinhCapTHCSDao : BaseDAL
    {
        public TuyenSinhCapTHCSDao(SqlDbProvider dbProvider) : base(dbProvider)
        {
        ...
        public Ghs_Tuyen_Sinh_Cap_THCS mapdata(TuyenSinhCapTHCSModel item)
        {
            var data = new Ghs_Tuyen_Sinh_Cap_THCS();
            ...
            data.lop_1_kq = item.lop_1_kq;
            data.lop_2_kq = item.lop_2_kq;
            data.lop_3_kq = item.lop_3_kq;
            data.lop_4_kq = item.lop_4_kq;
            data.lop_5_kq = item.lop_5_kq;
        ...
        #endregion
        public class TuyenSinhCapTHCSModel
        {
            ...
            public string? lop_1_kq { get; set; }
            public string? lop_2_kq { get; set; }
            public string? lop_3_kq { get; set; }
