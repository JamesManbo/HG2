...
/****** Object:  Table [dbo].[ghs_tuyen_sinh_cap_tieu_hoc]    Script Date: 7/25/2022 2:32:37 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[ghs_tuyen_sinh_cap_tieu_hoc](
	...
	[stt] [int] NULL,
 CONSTRAINT [PK_ghs_tuyen_sinh_cap_tieu_hoc] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
