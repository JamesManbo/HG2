...
namespace HG.WebApp.Controllers.Client
{
    public class LichTrucController : BaseController
    {
        ...
        public IActionResult QuanLy(int nam, string type = "", string oid = "")
        {
            ...
            ViewBag.PageSize = 0;
            ViewBag.NgaySua = data.ngay_nghi.UpdatedDateUtc != null ? data.ngay_nghi.UpdatedDateUtc.Value.ToString("dd/MM/yyyy") : "";
            ViewBag.NgayTao = data.ngay_nghi.CreatedDateUtc != null ? data.ngay_nghi.CreatedDateUtc.Value.ToString("dd/MM/yyyy") : "";
