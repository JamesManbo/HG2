(function ($) {
    ...
    $__default['default'].fn.filterMultiSelect = function (args) {
      ...
      if (typeof args.placeholderText === 'undefined') args.placeholderText = 'Bạn chưa chọn danh mục';
      if (typeof args.filterText === 'undefined') args.filterText = 'Filter';
      if (typeof args.selectAllText === 'undefined') args.selectAllText = 'Chọn tất cả';
